...
subtitle: "Модель хищник-жертва - вариант 37"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.79x(t) + 0.078y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.77y(t) - 0.076y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=9, y_0=18$
...
Стационарное состояние $x_0=\frac{a}{b}=10.128, y_0=\frac{c}{d}=10.131$
