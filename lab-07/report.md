...
subtitle: "Модель распространения рекламы - вариант 37"
...
1.	$\frac{dn}{dt} = (0.13 + 0.000013n(t))(N-n(t))$
2.	$\frac{dn}{dt} = (0.000031 + 0.31n(t))(N-n(t))$
3.	$\frac{dn}{dt} = (0.13t + 0.31\cos{t}n(t))(N-n(t))$

При этом объем аудитории $N = 1140$, в начальный момент о товаре знает 10 человек.
